$PBExportHeader$uo_vzt_room.sru
forward
global type uo_vzt_room from UserObject
end type
type dw_company from uo_vzt_dwbase within uo_vzt_room
end type
end forward
...
global uo_vzt_room uo_vzt_room
...
inv_company.uf_init(false, false, 'area_name_caps', true, 'd_gcc_room' )
this.is_data_col = 'area_number' 
