$PBExportHeader$w_report_slugold.srw
$PBExportComments$Report slug for inheritance on Q&A Reports
forward
global type w_report_slugold from window
end type
type dw_2 from datawindow within w_report_slugold
end type
type dw_1 from datawindow within w_report_slugold
end type
end forward
...
event type long ue_sharedataon ( str_dts_report_parms a_parms )
...
global w_report_slugold w_report_slugold
...
dw_1.modify('summary1.text = "'+ istr_report_parms.s_report_parms1+'"')
dw_1.modify('summary2.text = "'+ istr_report_parms.s_report_parms2+'"')

nRetCode = istr_report_parms.dwsource.ShareData( dw_2 )
If  nRetCode <> 1 Then
...
dw_2.modify('summary1.text = "'+ istr_report_parms.s_report_parms1+'"')
dw_2.modify('summary2.text = "'+ istr_report_parms.s_report_parms2+'"')
return 0
end event
...
report_type = istr_report_parms.cReportType
