$PBExportHeader$u_multi_select_01.sru
forward
global type u_multi_select_01 from userobject
end type
type uo_lb_1 from listbox within u_multi_select_01
end type
type uo_ddlb_1 from dropdownlistbox within u_multi_select_01
end type
end forward
...
global u_multi_select_01 u_multi_select_01
...
on u_multi_select_01.create
this.uo_lb_1=create uo_lb_1
this.uo_ddlb_1=create uo_ddlb_1
this.Control[]={this.uo_lb_1,&
this.uo_ddlb_1}
end on

on u_multi_select_01.destroy
...
IF Upper( Trim( uo_ddlb_1.Text ) ) = "[SELECTED]" Then
	if load_lb = "" or load_lb = 'guest' or load_lb = 'equipment' then // single item in listbox
