$PBExportHeader$u_ddcal_vz.sru
forward
global type u_ddcal_vz from userobject
end type
type sle_date from editmask within u_ddcal_vz
end type
type cb_1 from commandbutton within u_ddcal_vz
end type
type st_2 from statictext within u_ddcal_vz
end type
type st_1 from statictext within u_ddcal_vz
end type
type mle_ddcal from multilineedit within u_ddcal_vz
end type
type p_next from picture within u_ddcal_vz
end type
type p_prev from picture within u_ddcal_vz
end type
type p_ddlb from picture within u_ddcal_vz
end type
type sle_date1 from singlelineedit within u_ddcal_vz
end type
type dw_cal from datawindow within u_ddcal_vz
end type
end forward
