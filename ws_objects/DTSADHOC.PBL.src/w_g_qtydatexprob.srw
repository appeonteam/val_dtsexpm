$PBExportHeader$w_g_qtydatexprob.srw
forward
global type w_g_qtydatexprob from w_graph_sheet_using_dw
end type
end forward
...
string Title="Daily Calls per Problem"
string MenuName="m_graph"
end type
global w_g_qtydatexprob w_g_qtydatexprob

event open;window activesheet
string sheet_name, report_type, dw_mod0, dw_mod1,dw_mod2,dw_mod3, dw_mod_result
...
on w_g_qtydatexprob.create
call super::create
if this.MenuName = "m_graph" then this.MenuID = create m_graph
end on

on w_g_qtydatexprob.destroy
call super::destroy
if IsValid(MenuID) then destroy(MenuID)
end on

type dw_1 from w_graph_sheet_using_dw`dw_1 within w_g_qtydatexprob
int X=73
int Y=0
string DataObject="g_qty_x_date_x_prob"
end type
