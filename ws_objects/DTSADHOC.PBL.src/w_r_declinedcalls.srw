$PBExportHeader$w_r_declinedcalls.srw
forward
global type w_r_declinedcalls from window
end type
type dw_2 from datawindow within w_r_declinedcalls
end type
type cb_2 from commandbutton within w_r_declinedcalls
end type
type cb_1 from commandbutton within w_r_declinedcalls
end type
type dw_1 from datawindow within w_r_declinedcalls
end type
type st_4 from statictext within w_r_declinedcalls
end type
type st_3 from statictext within w_r_declinedcalls
end type
type st_2 from statictext within w_r_declinedcalls
end type
type uo_dept from u_multi_select_01 within w_r_declinedcalls
end type
type uo_dt_to from u_ddcal within w_r_declinedcalls
end type
type uo_dt_fr from u_ddcal within w_r_declinedcalls
end type
end forward

global type w_r_declinedcalls from window
string tag = "Declined Call"
integer width = 3474
integer height = 2052
boolean titlebar = true
string title = "Employee Declined Call Report"
...
global w_r_declinedcalls w_r_declinedcalls
...
integer taborder = 60
string title = "none"
string dataobject = "r_declined_calls_rpt"
...
integer taborder = 50
string title = "none"
string dataobject = "r_declined_calls"
