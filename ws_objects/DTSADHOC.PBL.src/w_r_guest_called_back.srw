$PBExportHeader$w_r_guest_called_back.srw
forward
global type w_r_guest_called_back from window
end type
type p_1 from picture within w_r_guest_called_back
end type
type dw_2 from datawindow within w_r_guest_called_back
end type
type cb_2 from commandbutton within w_r_guest_called_back
end type
type cb_1 from commandbutton within w_r_guest_called_back
end type
type dw_1 from datawindow within w_r_guest_called_back
end type
type st_4 from statictext within w_r_guest_called_back
end type
type st_3 from statictext within w_r_guest_called_back
end type
type st_2 from statictext within w_r_guest_called_back
end type
type uo_dept from u_multi_select_01 within w_r_guest_called_back
end type
type uo_dt_to from u_ddcal within w_r_guest_called_back
end type
type uo_dt_fr from u_ddcal within w_r_guest_called_back
end type
end forward

global type w_r_guest_called_back from window
string tag = "Guest Called Back"
integer width = 3474
integer height = 2052
boolean titlebar = true
string title = "Guest Called Back Report"
...
global w_r_guest_called_back w_r_guest_called_back
...
on w_r_guest_called_back.create
this.p_1=create p_1
...
on w_r_guest_called_back.destroy
destroy(this.p_1)
destroy(this.dw_2)
destroy(this.cb_2)
destroy(this.cb_1)
...
integer taborder = 60
string title = "none"
string dataobject = "r_called_back2_rpt"
...
integer taborder = 50
string title = "none"
string dataobject = "r_called_back2"
