$PBExportHeader$w_g_qtyxhour.srw
forward
global type w_g_qtyxhour from w_graph_sheet_using_dw
end type
end forward
...
string Title="Qty of Calls per Hour Across Days"
string MenuName="m_graph"
end type
global w_g_qtyxhour w_g_qtyxhour
...
on w_g_qtyxhour.create
call super::create
if this.MenuName = "m_graph" then this.MenuID = create m_graph
end on

on w_g_qtyxhour.destroy
call super::destroy
if IsValid(MenuID) then destroy(MenuID)
end on

type dw_1 from w_graph_sheet_using_dw`dw_1 within w_g_qtyxhour
int X=73
int Y=0
string DataObject="g_qty_x_hour"
end type
