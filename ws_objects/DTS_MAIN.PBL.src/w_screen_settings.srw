$PBExportHeader$w_screen_settings.srw
forward
global type w_screen_settings from window
end type
type p_1 from picture within w_screen_settings
end type
type cb_ok from commandbutton within w_screen_settings
end type
type cb_cancel from commandbutton within w_screen_settings
end type
type st_6 from statictext within w_screen_settings
end type
type tab_setting from tab within w_screen_settings
end type
...
type lb_1 from listbox within w_screen_settings
end type
end forward
...
global w_screen_settings w_screen_settings
