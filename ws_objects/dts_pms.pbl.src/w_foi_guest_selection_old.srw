$PBExportHeader$w_foi_guest_selection_old.srw
forward
global type w_foi_guest_selection_old from w_vzt_base_response
end type
type st_1 from statictext within w_foi_guest_selection_old
end type
end forward
...
global w_foi_guest_selection_old w_foi_guest_selection_old

on w_foi_guest_selection_old.create
int iCurrent
call super::create
...
on w_foi_guest_selection_old.destroy
call super::destroy
destroy(this.st_1)
end on
...
istr_parms.dw1.ShareData( dw_response) 
...
type dw_response from w_vzt_base_response`dw_response within w_foi_guest_selection_old
integer x = 32
integer y = 144
integer width = 1289
integer height = 380
...
type cb_2 from w_vzt_base_response`cb_2 within w_foi_guest_selection_old
integer x = 791
integer y = 552
integer height = 72
end type

type cb_1 from w_vzt_base_response`cb_1 within w_foi_guest_selection_old
integer x = 357
integer y = 552
integer height = 72
end type
