...
type dw_response from uo_vzt_dwbase within w_base_response
end type
type cb_2 from commandbutton within w_base_response
end type
type cb_1 from commandbutton within w_base_response
end type
end forward
