$PBExportHeader$uo_vzt_prefix.sru
forward
global type uo_vzt_prefix from UserObject
end type
type dw_company from uo_vzt_dwbase within uo_vzt_prefix
end type
end forward
...
global uo_vzt_prefix uo_vzt_prefix

type variables
nvo_company	inv_company
uo_vzt_dwbase	idw_caller
string		is_caller_col, is_input, is_data_col='code'
...
inv_company.uf_init(false, false, 'codecaps', true, 'd_dddw_lookup_prefix' )
...
int Width=494
int Height=432
string DataObject="d_dddw_lookup_prefix"
