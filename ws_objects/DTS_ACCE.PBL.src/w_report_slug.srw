$PBExportHeader$w_report_slug.srw
$PBExportComments$Report slug for inheritance on Q&A Reports
forward
global type w_report_slug from window
end type
type dw_2 from datawindow within w_report_slug
end type
type dw_1 from datawindow within w_report_slug
end type
end forward
...
global w_report_slug w_report_slug
...
// the followings are to modify dw for date/time display setting specified in he_dts.ini file
...
dw_1.Move( 1, 1 )
dw_1.Resize( This.Width - 50, This.Height - 200 )
SetMicroHelp( dispatch_tracking_system.MicroHelpDefault )

end event

on w_report_slug.create
