...
event ue_sharedataon pbm_custom12
...
//SetMicroHelp( "Opening --> " + This.Title + " - Graph...please wait." )
//This.TriggerEvent( "ue_sharedataon" )
activesheet = w_main.GetActiveSheet()
This.Title = This.Title + " - Graph"	// enforces standard
//dw_1.SetTransObject( SQLCA )
//dw_1.Retrieve()
//If Len( Message.StringParm ) > 0 Then
//	SetMicroHelp( "Setting data-share for  [ " + This.Title + " ]  - Graph...please wait." )
