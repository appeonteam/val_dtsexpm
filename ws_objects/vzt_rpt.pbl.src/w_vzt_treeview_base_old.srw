$PBExportHeader$w_vzt_treeview_base_old.srw
forward
global type w_vzt_treeview_base_old from w_vzt_base
end type
type dw_detail from uo_vzt_dwbase within w_vzt_treeview_base_old
end type
type tv_1 from treeview within w_vzt_treeview_base_old
end type
type st_vertical from statictext within w_vzt_treeview_base_old
end type
type st_horizontal1 from statictext within w_vzt_treeview_base_old
end type
type dw_hier_base from uo_vzt_dwbase within w_vzt_treeview_base_old
end type
type dw_font_base from uo_vzt_dwbase within w_vzt_treeview_base_old
end type
type str_empxfers from structure within w_vzt_treeview_base_old
end type
end forward
...
global w_vzt_treeview_base_old w_vzt_treeview_base_old
...
event ue_item_rename();tv_1.EditLabels = TRUE 
tv_1.Editlabel( il_currentitem )
end event
...
on w_vzt_treeview_base_old.create
int iCurrent
call super::create
...
on w_vzt_treeview_base_old.destroy
call super::destroy
...
type uo_trace01 from w_vzt_base`uo_trace01 within w_vzt_treeview_base_old
end type

type dw_mainlist from w_vzt_base`dw_mainlist within w_vzt_treeview_base_old
boolean visible = false
end type

type cb_last_search from w_vzt_base`cb_last_search within w_vzt_treeview_base_old
integer taborder = 20
end type

type cb_close from w_vzt_base`cb_close within w_vzt_treeview_base_old
integer x = 750
integer y = 1744
integer taborder = 70
end type

type cb_delete1 from w_vzt_base`cb_delete1 within w_vzt_treeview_base_old
integer taborder = 130
end type

type cb_save from w_vzt_base`cb_save within w_vzt_treeview_base_old
integer x = 9
integer y = 1748
integer taborder = 110
end type

type cb_select from w_vzt_base`cb_select within w_vzt_treeview_base_old
boolean visible = false
integer taborder = 100
end type

type cb_new from w_vzt_base`cb_new within w_vzt_treeview_base_old
integer x = 251
integer y = 1748
integer taborder = 120
end type

type cb_newsearch from w_vzt_base`cb_newsearch within w_vzt_treeview_base_old
boolean visible = false
integer taborder = 90
end type

type cb_search from w_vzt_base`cb_search within w_vzt_treeview_base_old
boolean visible = false
integer y = 820
integer taborder = 80
end type

type st_foundrecs from w_vzt_base`st_foundrecs within w_vzt_treeview_base_old
boolean visible = false
integer x = 480
integer y = 1748
end type

type st_stop from w_vzt_base`st_stop within w_vzt_treeview_base_old
end type

type dw_data from w_vzt_base`dw_data within w_vzt_treeview_base_old
boolean visible = false
integer x = 1458
integer y = 32
integer width = 1367
...
type dw_print from w_vzt_base`dw_print within w_vzt_treeview_base_old
